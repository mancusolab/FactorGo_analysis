...
setwd(paste0("/project/nmancuso_8/elezhang/projects/FA/data/PanUKBB/4_sumstats/", datname))

querylist_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/data/PanUKBB/3_ldprune/", datname, "/pruned/", snpfile)
manifest <- read_tsv(paste0("/project/nmancuso_8/elezhang/projects/FA/data/PanUKBB/",phefile))
