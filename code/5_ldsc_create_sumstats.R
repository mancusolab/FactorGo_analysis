...
# read Z and loading
if (method == "svd"){
  loading_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/results/PanUKBB/", 
                         datname, "/tsvd.", datname, ".", svdscale,".k", K, ".V.tsv.gz")
  U_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/results/PanUKBB/", 
                   datname, "/tsvd.", datname, ".", svdscale,".k", K, ".U.tsv.gz")
  D_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/results/PanUKBB/", 
  ...
  EZ2_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/results/PanUKBB/",
                    datname, "/VB.", datname, ".k", K, ".scale", vbscale, ".EZ2.tsv.gz")
  Zm_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/results/PanUKBB/",
...
if (isTRUE(pseudoN)){
  sampleN <- read_tsv("/project/nmancuso_8/elezhang/projects/FA/data/PanUKBB/4_sumstats/phe2483.SampleN.tsv", col_names = TRUE)
