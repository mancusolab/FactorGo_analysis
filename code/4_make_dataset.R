...
indir <- "/scratch1/zzhang39/PanUKBB/"
outpath <- paste0("/project/nmancuso_8/elezhang/projects/FA/data/PanUKBB/4_sumstats/", datname, "/")

## query file need chr, pos, ref, alt, rsid
querylist_path <- paste0("/project/nmancuso_8/elezhang/projects/FA/data/PanUKBB/3_ldprune/", datname, "/pruned/", querylist)
