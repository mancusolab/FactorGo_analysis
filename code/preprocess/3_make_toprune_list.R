...
indir <- "./data/PanUKBB/2_varqc/"
outdir <- paste0("./data/PanUKBB/3_ldprune/", outdir_name, "/toprune/")
P3dir <- "./ldsc/reference_files/1000G_EUR_Phase3/plink_files/" # 1000G.EUR.QC.{chr}.bim
